...
app.get("/uploaded/:imdbID/:filename", checkSecret, uploaded);
app.put("/hash/:imdbID/:filename", checkSecret, putHash);
app.get("/hash/:imdbID/:filename", checkSecret, getHash);
app.get("/loaded/:imdbID/:filename", checkSecret, loaded);
app.get("/unload/:imdbID/:filename", checkSecret, unload);
